<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotAuthorized.aspx.cs" Inherits="DigitalCardsApp.NotAuthorized" %>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-4">
                                            <h1>Lo sentimos, no cuenta con autorización para ver esta página.</h1>                                           
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">Nuevo en DigitalCards?</p>
                                        <a class="text-primary fw-bold ms-2" href="Registry.aspx">Crea una cuenta</a>
                                    </div>
                                </div>
                            </div>
                        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPasswordPage.aspx.cs" Inherits="DigitalCardsApp.ResetPasswordPage" %>
...
<body>
    <form id="form1" runat="server" method="post">
        ...
        <div class="alert alert-success" id="successAlert" role="alert" visible="false" runat="server">
            El cambio de contraseña ha sido exitoso.
        </div>
                        ...
                        <div class="col-md-8 col-lg-6 col-xxl-3">
                            <div class="card mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <label for="tbContrasena" class="form-label">Nueva contraseña</label>

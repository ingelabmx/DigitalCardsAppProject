<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessInsertionPage.aspx.cs" Inherits="DigitalCardsApp.BusinessInsertionPage" %>
        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-center gap-2">
                                        <h5 class="card-title">Crear una tarjeta</h5>
                                    </div>
                                    <div class="mb-3">
                                        <input type="Text" class="form-control" placeholder="Escanear o buscar un cliente por su nombre de usuario o correo electrónico..." id="tbNombreCliente" runat="server">
                                    </div>
                                    <div class="d-flex justify-content-center gap-2">
                                        <button type="submit" class="btn btn-primary" id="btRegistrar" onserverclick="btRegistrar_ServerClick" runat="server">Agregar</button>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-center gap-2">
                                        <h5 class="card-title">Tarjetas del negocio</h5>
                                    </div>
            ...
            <script>
                document.getElementById("btEscanear").addEventListener("click", function () {
                    ...
                    const tbCliente = document.getElementById("<%= tbNombreCliente.ClientID %>"); // Access server-side control
                    const qrResult = document.getElementById("qr-result");
                    const qrCodeSpan = document.getElementById("qr-code");
                    const btChecar = document.getElementById("<%= btRegistrar.ClientID %>"); // Access 'Marcar checada' button

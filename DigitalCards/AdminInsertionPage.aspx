<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminInsertionPage.aspx.cs" Inherits="DigitalCardsApp.AdminInsertionPage" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="lbNegocioHelp" class="form-text">Escriba el nombre del negocio.</div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div id="lbContraNegocioHelp" class="form-text">Escriba la contraseña para la cuenta del negocio.</div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="lbEmailNegocioHelp" class="form-text">Escriba el correo electrónico del negocio.</div>
                                    </div>
                                    <div
                                        id="dropZone"
                                        ...
                                        Arrastra aquí el logo (220 píxeles de ancho por 100 píxeles de alto).
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        <button type="submit" class="btn btn-primary" id="btAgregar" onserverclick="btAgregar_ServerClick" runat="server">Agregar</button>
                                    </div>
                                </div>
                            </div>
                        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessLogin.aspx.cs" Inherits="DigitalCardsApp.BusinessLogin" %>
                        ...
                        <div class="col-md-8 col-lg-6 col-xxl-3">
                            <div class="card mb-0">
                                <div class="card-body">
                                    ...
                                    <h4 class="text-center">Inicio de sesión para negocios</h4>
                                    <div class="mb-3">
                                        <label for="tbEmail" class="form-label">Email del negocio</label>
                                    ...
                                    <a href="#" class="btn btn-primary w-100 py-8 fs-4 mb-4" runat="server" onserverclick="Login_Click">Iniciar sesión</a>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">¿Eres un cliente?
                                        <a class="text-primary fw-bold ms-2" href="Login.aspx">Ingresa aquí</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>

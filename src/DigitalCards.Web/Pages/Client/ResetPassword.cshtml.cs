...
public sealed class ResetPasswordModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken cancellationToken)
    {
        ...
        var result = await _appService.ResetClientPasswordAsync(
        ...
        _logger.LogInformation("Client password reset completed with token suffix {TokenSuffix}.", SafeSuffix(Token));
